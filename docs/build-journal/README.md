...
- 🔧 Echo cancellation over Bluetooth (open problem — [details](04-the-echo-problem.md))
...
|---------|-------|---------------|
| [01](01-hello-world.md) | **Hello World** | Pi 5 setup, XVF3800 dual-channel discovery, first transcription |
| [02](02-the-loop-closes.md) | **The Loop Closes** | Bose Bluetooth upgrade, first full conversation, ambient listener |
| [03](03-the-pivot.md) | **The Pivot** | Honest feedback killed our DIY pipeline. Pipecat saved the project. |
| [04](04-the-echo-problem.md) | **The Echo Problem** | Why AEC fails over Bluetooth, and what we're trying next |

**Reference:**
| Doc | What It Covers |
|-----|----------------|
| [XVF3800 Guide](05-xvf3800-guide.md) | Everything we wish someone had told us about the XVF3800 |
...
The pivot story — including the specific feedback that triggered it, the 90-minute turnaround, and the before/after metrics — is in [Chapter 3](03-the-pivot.md). It's probably the most useful chapter if you're deciding between building from scratch and using a framework.
...
Full details and the approaches we're evaluating: [Chapter 4](04-the-echo-problem.md).
...
The [XVF3800 Guide](05-xvf3800-guide.md) is standalone and useful regardless of your overall architecture — it covers the dual-channel output, gain tuning, and AEC behaviour that took us a full day to figure out.
